...
//}
//
//type InMemoryURLInterface interface {
//	Create()
//}
//
...
////}
//
//func (repo *DBURLRepository) Create(ctx context.Context, originalURL, shortURL string) (model.URLEntity, error) {
//
...
//		return model.URLEntity{}, fmt.Errorf("%w: short url already exists", urls.ErrShortURLAlreadyExists)
//	}
...
//
//			return entity, fmt.Errorf("%w: %s", urls.ErrOriginalURLAlreadyExists, originalURL)
//		}
//	}
//	if result == nil {
//		return model.URLEntity{}, urls.ErrURLNotCreated
//	}
//
...
//}
//
//func (repo *InMemoryURLRepository) Create(originalURL, shortURL string) (model.URLEntity, error) {
//	repo.mu.Lock()
//	defer repo.mu.Unlock()
//
//	if _, ok := repo.urls[originalURL]; ok {
//		return model.URLEntity{}, urls.ErrShortURLAlreadyExists
//	}
//
//	for _, url := range repo.urls {
//		if url == originalURL {
//			return model.URLEntity{}, urls.ErrOriginalURLAlreadyExists
//		}
//	}
//
...
//
//		if err != nil {
//			return "", fmt.Errorf("%w: %s", urls.ErrURLNotFound, shortURL)
//		}
//		return entity, nil
//	}
//
...
//		if err != nil {
//			if errors.As(err, &uniqueConstrErr) {
//				return nil, urls.ErrDuplicatedURL
//			}
...
//				return entity, fmt.Errorf("%w: %s", urls.ErrOriginalURLAlreadyExists, model.URLEntity{
...
//		if err != nil {
//			return updatedEntity, fmt.Errorf("%w", urls.ErrURLNotFound)
//		}
...
//			return updatedEntity, urls.ErrOriginalURLAlreadyExists
//		}
//	}
//
...
//		}
//	}
//	return updatedEntity, urls.ErrURLNotFound
//}
//
...
//		}
//		if isRemoved == 0 {
//			return fmt.Errorf("%w", urls.ErrURLNotFound)
//		}
//
//		return nil
//	}
...
//		}
//		if result != nil {
//			return false, urls.ErrURLListIsNotUnique
//		}
//		return true, nil
//	}
...
//	if ok {
//		return fmt.Errorf("%w: %s", urls.ErrShortURLAlreadyExists, urlEntity.ShortURL)
//	}
