...
const (
	ShortenerService_ShortenURL_FullMethodName   = "/urlsProto.ShortenerService/ShortenURL"
	ShortenerService_ExpandURL_FullMethodName    = "/urlsProto.ShortenerService/ExpandURL"
	ShortenerService_ListUserURLs_FullMethodName = "/urlsProto.ShortenerService/ListUserURLs"
	ShortenerService_Login_FullMethodName        = "/urlsProto.ShortenerService/Login"
)
...
func (c *shortenerServiceClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LoginResponse)
	err := c.cc.Invoke(ctx, ShortenerService_Login_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ShortenerService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ShortenerService_Login_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ShortenerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "urlsProto.ShortenerService",
